...
public class StudentScoreFrame extends javax.swing.JFrame {
    ...
    private void examidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_examidActionPerformed
        ...
        percentage.setText("");
        try{
            String sub=ExamDAO.getSubject(examid.getSelectedItem().toString());
            double per=PerformanceDAO.getPercentage(examid.getSelectedItem().toString(), username.getText());
            
            if(sub.isEmpty())
                JOptionPane.showMessageDialog(null, "NO RESULT FOUND ","NO EXAMID",JOptionPane.ERROR_MESSAGE);
            else{
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        StudentOptionsFrame vsf=new StudentOptionsFrame();
        vsf.setVisible(true);
        this.dispose();
